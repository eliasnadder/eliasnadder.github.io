    ...
    <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
       ...
       <div className="w-full md:w-7/12 text-center md:text-left order-2 md:order-2">
          ...
          <div className="space-y-4 text-slate-600 dark:text-slate-400 leading-relaxed text-lg">
            <p>
              I'm a Full Stack Engineer with a passion for building comprehensive digital ecosystems. 
              While many developers specialize in one area, I thrive on the complexity of connecting 
              <span className="text-slate-900 dark:text-white font-semibold"> mobile applications</span>, 
              <span className="text-slate-900 dark:text-white font-semibold"> web dashboards</span>, and 
              <span className="text-slate-900 dark:text-white font-semibold"> robust backends</span> into a seamless experience.
            </p>
            <p>
              ...
              my focus is always on performance and user experience.
            </p>
          </div>
